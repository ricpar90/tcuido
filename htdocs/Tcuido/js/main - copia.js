...
$(function() {
    ...
    $('body.instalaciones .navegacion-principal a:contains("Galería")').addClass('activo');
    $('body.registro .navegacion-principal a:contains("Cita On-line")').addClass('activo');
    ...
    //Se ha intentado añadir añadir este plugin para la categoría de peluquería pero no ha sido posible
